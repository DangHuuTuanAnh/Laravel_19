...
<div class="container">
    <form action="{{route('task.store')}}" method="POST" class="" role="form">
        @csrf
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input name="name" type="text" class="form-control" id="todo" placeholder="Enter todo">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="control-label" for="todo">Thời hạn:</label>
             <input type="datetime-local" name="deadline" id="task-name" class="form-control" value="{{ old('task') }}">
        </div>
